<div>
								<table border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td>
											<div class="customer-table-data"><input type="text" name="firstnm" id="firstnm" style="width: 100%; border: 0; padding:0" value="<?php echo trim($custrow->firstname); ?>" ></div>
										</td>
										<td style="width:10px"><!--  --></td>
										<td style="padding-right:10px">
										...
										<td>
											<div class="customer-table-data"><input type="text" name="lastnm" id="lastnm" style="width: 100%; border: 0; padding:0" value="<?php echo trim($custrow->lastname); ?>" ></div>
										</td>
									</tr>
									<tr><td style="height:10px"><!--  --></td></tr>
									<tr>
										...
										<td>
											<div class="customer-table-data"><input type="password" name="custpwd" id="custpwd" style="width: 100%; border: 0; padding:0" value="<?php echo trim($custrow->password); ?>" ></div>
										</td>
									</tr>
									<tr><td style="height:10px"><!--  --></td></tr>
									<tr>
